...
export default function SocialAuthButtons({ action }: SocialAuthButtonsProps) {
  return (
    <>
      ...
      <button type="button" className="auth-provider-button" aria-label={`${action} con Google`}>
        <GoogleIcon />
        {action} con Google
      </button>
      <button type="button" className="auth-provider-button sm:hidden" aria-label={`${action} con Apple`}>
        <AppleIcon />
        {action} con Apple
      </button>
    </>
...
function GoogleIcon() {
  return (
    <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path fill="#FBBC05" d="M5.84 14.09A6.4 6.4 0 015.49 12c0-.73.13-1.43.35-2.09V7.07H2.18A11 11 0 001 12c0 1.78.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
